...
async def test_email_processing():
    ...
    with patch("helpers.openai_helper.async_safe_chat_completion", side_effect=mocked_safe_chat_completion):
...
async def test_email_processing():
    ...
    with patch("helpers.openai_helpers.async_safe_chat_completion", side_effect=mocked_safe_chat_completion):
        classification = await processor.classify_email(email)  # Await the async method
        assert classification == "inquiry", f"Expected 'inquiry', got {classification}"
